...
;define("todomvc/app", ["exports", "@ember/application", "ember-resolver", "ember-load-initializers", "todomvc/config/environment"], function (_exports, _application, _emberResolver, _emberLoadInitializers, _environment) {
  ...
  0; //eaimeta@70e063a35619d71f0,"@ember/application",0,"ember-resolver",0,"ember-load-initializers",0,"todomvc/config/environment"eaimeta@70e063a35619d71f
...
;define("todomvc/components/cart-contents", ["exports", "@ember/component", "@glimmer/component", "@ember/service", "@ember/object", "@ember/template-factory"], function (_exports, _component, _component2, _service, _object, _templateFactory) {
  "use strict";
  ...
  */
  {
    "id": "t019sSiJ",
    "block": "[[[10,\"ul\"],[12],[1,\"\\n\"],[42,[28,[37,2],[[28,[37,2],[[30,0,[\"cart\",\"items\"]]],null]],null],null,[[[1,\"  \"],[10,\"li\"],[12],[1,\"\\n    \"],[1,[30,1,[\"name\"]]],[1,\"\\n    \"],[11,\"button\"],[24,4,\"button\"],[4,[38,5],[\"click\",[28,[37,6],[[30,0,[\"remove\"]],[30,1]],null]],null],[12],[1,\"Remove\"],[13],[1,\"\\n  \"],[13],[1,\"\\n\"]],[1]],null],[13]],[\"item\"],false,[\"ul\",\"each\",\"-track-array\",\"li\",\"button\",\"on\",\"fn\"]]",
    "moduleName": "todomvc/components/cart-contents.hbs",
    "isStrictMode": false
  });
  let CartContentsComponent = _exports.default = (_dec = (0, _service.service)('shopping-cart'), _class = class CartContentsComponent extends _component2.default {
    constructor(...args) {
      super(...args);
  ...
  (0, _component.setComponentTemplate)(__COLOCATED_TEMPLATE__, CartContentsComponent);
});
...
;define("todomvc/container-debug-adapter", ["exports", "ember-resolver/container-debug-adapter"], function (_exports, _containerDebugAdapter) {
  "use strict";
...
;define("todomvc/data-adapter", ["exports", "@ember-data/debug/data-adapter"], function (_exports, _dataAdapter) {
  "use strict";
...
;define("todomvc/helpers/app-version", ["exports", "@ember/component/helper", "todomvc/config/environment", "ember-cli-app-version/utils/regexp"], function (_exports, _helper, _environment, _regexp) {
  ...
  _exports.default = void 0;
  0; //eaimeta@70e063a35619d71f0,"@ember/component/helper",0,"todomvc/config/environment",0,"ember-cli-app-version/utils/regexp"eaimeta@70e063a35619d71f
...
;define("todomvc/initializers/app-version", ["exports", "ember-cli-app-version/initializer-factory", "todomvc/config/environment"], function (_exports, _initializerFactory, _environment) {
  ...
  _exports.default = void 0;
  0; //eaimeta@70e063a35619d71f0,"ember-cli-app-version/initializer-factory",0,"todomvc/config/environment"eaimeta@70e063a35619d71f
  let name, version;
...
;define("todomvc/initializers/ember-data", ["exports", "@ember-data/request-utils/deprecation-support"], function (_exports, _deprecationSupport) {
  "use strict";
...
;define("todomvc/router", ["exports", "@ember/routing/router", "todomvc/config/environment"], function (_exports, _router, _environment) {
  ...
  _exports.default = void 0;
  0; //eaimeta@70e063a35619d71f0,"@ember/routing/router",0,"todomvc/config/environment"eaimeta@70e063a35619d71f
  function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
  function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
  function _toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
;define("todomvc/services/shopping-cart", ["exports", "tracked-built-ins", "@ember/service"], function (_exports, _trackedBuiltIns, _service) {
  "use strict";
  ...
  _exports.default = void 0;
  0; //eaimeta@70e063a35619d71f0,"tracked-built-ins",0,"@ember/service"eaimeta@70e063a35619d71f
  function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
  function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
  function _toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
  class ShoppingCartService extends _service.default {
    constructor(...args) {
      super(...args);
      _defineProperty(this, "items", new _trackedBuiltIns.TrackedArray([]));
    }
    add(item) {
...
;define("todomvc/services/store", ["exports", "@ember/debug", "ember-data/store"], function (_exports, _debug, _store) {
  "use strict";
...
;define("todomvc/templates/application", ["exports", "@ember/template-factory"], function (_exports, _templateFactory) {
  ...
  <div class="row my-row">
    <div class="col-sm-6">
      <div class="card">
        <i class="fa-solid fa-thumbs-up fa-5x card-img-top" alt="..." />
        <div class="card-body">
  ...
  */
  {
    "id": "v1iJVYi7",
    "block": "[[[1,\"\\n\"],[8,[39,0],null,null,null],[1,\"\\n\\n\"],[10,0],[14,0,\"row my-row\"],[12],[1,\"\\n  \"],[10,0],[14,0,\"col-sm-6\"],[12],[1,\"\\n    \"],[10,0],[14,0,\"card\"],[12],[1,\"\\n      \"],[10,\"i\"],[14,0,\"fa-solid fa-thumbs-up fa-5x card-img-top\"],[14,\"alt\",\"...\"],[12],[13],[1,\"\\n      \"],[10,0],[14,0,\"card-body\"],[12],[1,\"\\n        \"],[10,\"h5\"],[14,0,\"card-title\"],[12],[1,\"Card title\"],[13],[1,\"\\n        \"],[10,2],[14,0,\"card-text\"],[12],[1,\"Some quick example text to build on the card title and make up the bulk of the card's\\n          content.\\n        \"],[13],[1,\"\\n        \"],[10,3],[14,6,\"#\"],[14,0,\"btn btn-primary\"],[12],[1,\"Go somewhere\"],[13],[1,\"\\n      \"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"],[13],[1,\"\\n  \"],[10,0],[14,0,\"col-sm-6\"],[12],[1,\"\\n    \"],[10,0],[14,0,\"card\"],[12],[1,\"\\n      \"],[10,\"i\"],[14,0,\"fa-solid fa-thumbs-up fa-5x card-img-top\"],[14,\"alt\",\"...\"],[12],[13],[1,\"\\n      \"],[10,0],[14,0,\"card-body\"],[12],[1,\"\\n        \"],[10,\"h5\"],[14,0,\"card-title\"],[12],[1,\"Card title\"],[13],[1,\"\\n        \"],[10,2],[14,0,\"card-text\"],[12],[1,\"Some quick example text to build on the card title and make up the bulk of the card's\\n          content.\\n        \"],[13],[1,\"\\n        \"],[10,3],[14,6,\"#\"],[14,0,\"btn btn-primary\"],[12],[1,\"Go somewhere\"],[13],[1,\"\\n      \"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"],[13],[1,\"\\n\"],[13],[1,\"\\n\"],[10,0],[14,0,\"row my-row\"],[12],[1,\"\\n  \"],[10,0],[14,0,\"col-sm-6\"],[12],[1,\"\\n    \"],[10,0],[14,0,\"card\"],[12],[1,\"\\n      \"],[10,0],[14,0,\"card-body\"],[12],[1,\"\\n        \"],[10,\"h5\"],[14,0,\"card-title\"],[12],[1,\"Special title treatment\"],[13],[1,\"\\n        \"],[10,2],[14,0,\"card-text\"],[12],[1,\"With supporting text below as a natural lead-in to additional content.\"],[13],[1,\"\\n        \"],[10,3],[14,6,\"#\"],[14,0,\"btn btn-primary\"],[12],[1,\"Go somewhere\"],[13],[1,\"\\n      \"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"],[13],[1,\"\\n  \"],[10,0],[14,0,\"col-sm-6\"],[12],[1,\"\\n    \"],[10,0],[14,0,\"card\"],[12],[1,\"\\n      \"],[10,0],[14,0,\"card-body\"],[12],[1,\"\\n        \"],[10,\"h5\"],[14,0,\"card-title\"],[12],[1,\"Special title treatment\"],[13],[1,\"\\n        \"],[10,2],[14,0,\"card-text\"],[12],[1,\"With supporting text below as a natural lead-in to additional content.\"],[13],[1,\"\\n        \"],[10,3],[14,6,\"#\"],[14,0,\"btn btn-primary\"],[12],[1,\"Go somewhere\"],[13],[1,\"\\n      \"],[13],[1,\"\\n    \"],[13],[1,\"\\n  \"],[13],[1,\"\\n\"],[13]],[],false,[\"cart-contents\",\"div\",\"i\",\"h5\",\"p\",\"a\"]]",
    "moduleName": "todomvc/templates/application.hbs",
    "isStrictMode": false
  });
});
;define("todomvc/transforms/boolean", ["exports", "@ember/debug", "@ember-data/serializer/transform"], function (_exports, _debug, _transform) {
  "use strict";
...
;define("todomvc/transforms/date", ["exports", "@ember/debug", "@ember-data/serializer/transform"], function (_exports, _debug, _transform) {
  "use strict";
...
;define("todomvc/transforms/number", ["exports", "@ember/debug", "@ember-data/serializer/transform"], function (_exports, _debug, _transform) {
  "use strict";
...
;define("todomvc/transforms/string", ["exports", "@ember/debug", "@ember-data/serializer/transform"], function (_exports, _debug, _transform) {
  "use strict";
